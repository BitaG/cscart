<?php /* Smarty version Smarty-3.1.21, created on 2019-01-09 18:27:07
         compiled from "/var/www/html/design/backend/templates/views/shipments/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4134302065c3612cb47c242-05598617%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4134302065c3612cb47c242-05598617',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c3612cb4d2761_60650016',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c3612cb4d2761_60650016')) {function content_5c3612cb4d2761_60650016($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/app/functions/smarty_plugins/modifier.date_format.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('shipment_id','order_id','shipment_date','order_date','customer','status','shipment_id','order_id','shipment_date','order_date','customer','tools','view','print_slip','print_pdf_packing_slip','delete','status','no_data','bulk_print_packing_slip','shipments','order'));
?>
