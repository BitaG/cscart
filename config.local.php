 ...
 */
$config['db_host'] = 'bitabi00.mysql.tools';
$config['db_name'] = 'bitabi00_cscart';
$config['db_user'] = 'bitabi00_cscart';
$config['db_password'] = 'g_O)s5V3p9';
...
$config['http_host'] = 'cscart.bitabit.com.ua';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'cscart.bitabit.com.ua';
$config['https_path'] = '';
